...
render scm st Discussion = applyColorSchema scm st svgDiscussion
...
render scm st Edit = applyColorSchema scm st svgEdit
...
render scm st Login = applyColorSchema scm st svgLogin
...
render scm st Share = applyColorSchema scm st svgShare
