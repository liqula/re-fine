...
changeAccess :: ChangeAccess -> App DB UH ()
...
changeNoteAccess :: ID Note -> Access -> ID User -> App DB UH  ()
...
changeDiscussionAccess :: ID Discussion -> Access -> ID User -> App DB UH ()
...
changeQuestionAccess :: ID Question -> Access -> ID User -> App DB UH ()
